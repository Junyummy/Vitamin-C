...
public class Nemonemo15X7 extends AbNemo
{
	OtherFrame other;
	JPanel nemo;
	...
	String data = "000000000000000000001111111110000001000000010000001000000010000001000000010000001111111110000000111111010000001111111010000001000011010000011111001110001111111101010011000011111010010000001111110010000001000010011111111111110"; //문제의 정답(부츠)

	public static boolean endFlag = false; //퍼즐이 풀렸는지 여부
	
	public Nemonemo15X7(OtherFrame.JPanelTest win)
	{
		setLayout(null);
		this.win = win;
		//변수 초기화
	...
	public void display() //퍼즐이 풀렸는지 여부를 검사
	{
		...
		if(endFlag)
		{
			Nemonemo15X7.endFlag = endFlag;
			board.repaint(); //퍼즐이 다 풀렸으면 보드의 칸을 채움
		}
	}
	
	public boolean getendFlag() {
		return Nemonemo15X7.endFlag;
	}
}