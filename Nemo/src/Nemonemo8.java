...
public class Nemonemo8 extends AbNemo{
	...
	public Nemonemo8(OtherFrame.JPanelTest win)
	{
		setLayout(null);
		this.win = win;
		//변수 초기화
		...
		numOfRow = new int[10];
		nemo8 = new JPanel();
		nemo8.setBackground(Color.white);
		nemo8.setLayout(null); //null 레이아웃으로 설정
		
		//column 생성
		col = new Column8(this);
		this.add(col);
	...
	public void display() {
		...
		if(endFlag)
		{
			Nemonemo8.endFlag = endFlag;
			board.repaint(); //퍼즐이 다 풀렸으면 보드의 칸을 채움
		}
	}
	
	public boolean getendFlag() {
		return Nemonemo8.endFlag;
	}
}
