...
public class Nemo15Cow extends Canvas //Canvas 클래스를 상속
implements MouseListener, MouseMotionListener
{	
Nemonemo15X2 parent; //Nemonemo 클래스의 객체를 저장
...
public Nemo15Cow(Nemonemo15X2 nemo) //Nemonemo 클래스의 객체를 보관하고 리스너를 선언
{
