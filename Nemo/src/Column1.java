...
public class Column1 extends Canvas //Canvas 클래스를 상속
{

	Nemonemo1 parent; //Nemonemo 클래스의 객체를 저장
	
	Image offScr; //더블버퍼링을 위한 가상 화면
	Graphics offG;
	
	public Column1(Nemonemo1 nemo) //Nemonemo 클래스의 객체를 보관하고 모든열의 연속한 '1'의 개수를 계산
	{
		this.parent = nemo;
		getColumn();
	}
