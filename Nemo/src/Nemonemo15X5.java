...
public class Nemonemo15X5 extends AbNemo
{
	OtherFrame other;
	JPanel nemo;
	...
	String data = "011011000000000011011000000000011011000000000011011000000000011011000000000011011000000000011111000000000111111100000000101110100111110111111101111111111111111111111011111111111111000011111111111011111111111100011111111111100"; //문제의 정답(토)

	public static boolean endFlag = false; //퍼즐이 풀렸는지 여부
	
	public Nemonemo15X5(OtherFrame.JPanelTest win)
	{
		setLayout(null);
		this.win = win;
		//변수 초기화
	...
	public void display() //퍼즐이 풀렸는지 여부를 검사
	{
		...
		if(endFlag)
		{
			Nemonemo15X5.endFlag = endFlag;
			board.repaint(); //퍼즐이 다 풀렸으면 보드의 칸을 채움
		}
	}
	
	public boolean getendFlag() {
		return Nemonemo15X5.endFlag;
	}
}
